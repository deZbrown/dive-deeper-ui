                ...
                <form onSubmit={submitForm}>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            type="email"
                            value={email}
                            className="block mt-1 w-full dark:bg-gray-800 dark:text-white"
                    ...
                    <div className="flex items-center justify-end mt-4 dark:text-white">
                        <Link
                            href="/forgot-password"
                            className="underline text-sm text-gray-600 hover:text-gray-900 dark:text-gray-200 dark:hover:text-white">
